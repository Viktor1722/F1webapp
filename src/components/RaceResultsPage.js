...
export function RaceResultsPage({ selectedYear }) {
  ...
  return (
    <div className="race-results global-container ">
      <h1 className=" text-center mb-40 text-neutral-400">Race Results</h1>
      {isLoading ? (
        <Loading
            ...
            <li key={index}>
              {race.results ? (
                ...
                <div className="flex justify-center">
                  <img
                    alt=""
                    src={`${process.env.PUBLIC_URL + "/images/podium.png"}`}
                    width={324}
                  />
                </div>
              )}
              ...
              <div
                className={classNames("divider-glow-medium mb-16", {
                  "mt-32": !race.results,
                })}
              />
            </li>
